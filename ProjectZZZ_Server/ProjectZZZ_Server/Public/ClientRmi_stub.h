...
namespace ClientToServer {
	...
	public:
		...
		virtual bool OnGameLogin ( ::Proud::HostID, ::Proud::RmiContext& , const int & , const int & , const string & , const string & , const string & , const string & )		{ 
			return false;
		} 

#define DECRMI_ClientToServer_OnGameLogin bool OnGameLogin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const int & LoginType, const string & szID, const string & szPassWord, const string & uid, const string & email) PN_OVERRIDE

#define DEFRMI_ClientToServer_OnGameLogin(DerivedClass) bool DerivedClass::OnGameLogin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const int & LoginType, const string & szID, const string & szPassWord, const string & uid, const string & email)
#define CALL_ClientToServer_OnGameLogin OnGameLogin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const int & LoginType, const string & szID, const string & szPassWord, const string & uid, const string & email)
#define PARAM_ClientToServer_OnGameLogin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const int & LoginType, const string & szID, const string & szPassWord, const string & uid, const string & email)
...
#define PARAM_ClientToServer_OnChat ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const string & message)
	...
	public:
		...
		std::function< bool ( ::Proud::HostID, ::Proud::RmiContext& , const int & , const int & , const string & , const string & , const string & , const string & ) > OnGameLogin_Function;
		virtual bool OnGameLogin ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext , const int & clientId, const int & LoginType, const string & szID, const string & szPassWord, const string & uid, const string & email) 
		{ 
			if (OnGameLogin_Function==nullptr) 
				return true; 
			return OnGameLogin_Function(remote,rmiContext, clientId, LoginType, szID, szPassWord, uid, email); 
		}
